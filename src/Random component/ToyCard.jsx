  ...
  return (
    <div>
      <div className="col h-100">
        <div className="card rounded-5 rounded-top-0 h-100" style={{ backgroundImage: 'url(https://img.freepik.com/free-vector/colorful-blocks-blank-white-background-vector_53876-67037.jpg?w=740&t=st=1700891472~exp=1700892072~hmac=5bd5628c418334b8460025634e8a3fc010836fc6400feee487b3410639113739)', backgroundSize: 'cover', backgroundPosition: 'center', objectFit: 'contain' }}>
